#!/usr/bin/env python3
"""
Interactive Index Creation Script for AcademicRAG RAG System

This script provides a user-friendly interface for creating document indexes
using the AcademicRAG RAG system. It supports both single documents and batch
...
class IndexCreator:
    ...
    def create_index_interactive(self) -> None:
        ...
        print(" AcademicRAG Index Creation Tool")
        print("=" * 50)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="AcademicRAG Index Creation Tool")
