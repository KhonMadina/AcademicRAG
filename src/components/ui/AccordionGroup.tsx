...
export function AccordionGroup({ title, children, defaultOpen }: Props) {
  return (
    <details open={defaultOpen} className="border-t border-black/10 py-4 group">
      <summary className="cursor-pointer select-none list-none text-xs uppercase tracking-wide mb-3 flex items-center gap-2">
        {title}
        <svg
